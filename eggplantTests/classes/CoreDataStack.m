...
@property (nonatomic, readwrite, strong) NSString *modelName;
...
{
    return [[self alloc] initWithModelName:modelName fileName:fileName];
}

- (id)initWithModelName:(NSString *)modelName
{
    return [self initWithModelName:modelName fileName:modelName];
}
...
- (NSManagedObjectContext *)managedObjectContext
{
    ...
    if (coordinator != nil) {
        // Use NSMainQueueConcurrencyType instead of default init with NSConfinementConcurrencyType
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSString *fileName = [NSString stringWithFormat:@"%@.sqlite", self.fileName];
